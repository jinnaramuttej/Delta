  ...
  return (
    <div className="flex h-screen flex-col bg-neutral-950 text-neutral-100">
      <header className="border-b border-neutral-800 bg-neutral-950/80 px-8 py-4 backdrop-blur-md">
        <h1 className="text-xl font-bold tracking-tight text-neutral-50">Go-To-Market Agent</h1>
        <p className="text-xs text-neutral-500 mt-0.5">Generate landing page descriptions, marketing copies, and social templates</p>
      </header>
        ...
        <div className="mx-auto max-w-2xl space-y-6 pb-28">
          ...
          {actions.length === 0 && !loading ? (
            <div className="flex flex-col items-center justify-center py-20 text-center text-neutral-500">
              <p className="text-sm">No GTM assets yet. Request a launch post or marketing slogan below.</p>
            </div>
          ) : (
            actions.map((card) => (
              <div
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold uppercase tracking-wider bg-purple-500/10 text-purple-400 border border-purple-500/20">
                    GTM
                  </span>
      ...
      <footer className="fixed bottom-0 left-64 right-0 border-t border-neutral-800 bg-neutral-950/80 p-4 backdrop-blur-md">
        <form onSubmit={handleSubmit} className="mx-auto max-w-2xl flex gap-2">
          <input
            ...
            placeholder="Draft a positioning statement or social media copy..."
            disabled={loading}
